...
>This repo uses hard-coded values in code to explain the concept of hard-coding. For real projects, dynamic assignment is the right approach .I created a separate repository only to explain this concept .<br>
